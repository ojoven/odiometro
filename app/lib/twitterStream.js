...
if (global.lang === 'es') {
	twitterStream = twitterObject.stream('statuses/filter', { track: track, language: 'es', place: 'Spain' });
} else {
	twitterStream = twitterObject.stream('statuses/filter', { track: track, language: 'en'});
}
